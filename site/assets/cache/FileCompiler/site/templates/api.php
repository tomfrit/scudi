<?php
	if($user->isLoggedIn() && $user->strava_id) {
		...
		$f = array('rides'=>'getRides','dude'=>'getDude','init'=>'importRides','dude'=>'getDude','logout'=>'logout','importUserRides'=>'importUserRides','updateRides'=>'updateRides','status'=>'getStatus');
		$method = $f{$func};
